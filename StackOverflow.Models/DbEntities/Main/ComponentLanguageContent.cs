...
namespace StackOverflow.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(StackOverflow.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(StackOverflow.Models.Main.LanguageContent.ComponentLanguageContents))]
